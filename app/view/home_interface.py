...
class BannerWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.galleryLabel = QLabel('Natural Language Processing', self)
        ...
        self.linkCardView.addCard(
            ...
            self.tr('GitHub repo'),
            self.tr(
                'The latest NLP functions for your applications.'),
            REPO_URL
        )
        ...
        self.linkCardView.addCard(
            ...
            self.tr('Help us improve NLP functions by providing feedback.'),
            FEEDBACK_URL
        )
