...
from .stopword_interface import StopWordInterface
from .highfreq_interface import HighFrequencyInterface
...
class MainWindow(FramelessWindow):
    ...
    def __init__(self):
        ...
        self.segmentInterface = SegmentInterface(self)
        self.stopwordInterface = StopWordInterface(self)
        self.settingInterface = SettingInterface(self)
        self.highfrequencyInterface = HighFrequencyInterface(self)
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(
            self.segmentInterface, 'segmentInterface', Icon.TEXT, self.tr('Segment')
        )

        self.addSubInterface(
            self.stopwordInterface, 'stopwordInterface', FIF.DELETE, self.tr('Stopword')
        )

        self.addSubInterface(
            self.highfrequencyInterface,'highfreqInterface',FIF.HIGHTLIGHT,self.tr('Highfrequency')
        )
    ...
    def initWindow(self):
        ...
        self.setWindowTitle('Natural Language Process')
